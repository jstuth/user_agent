package de.parallax3d.user_agent;
...
/** UserAgentPlugin */
public class UserAgentPlugin implements MethodCallHandler {
  /** Plugin registration. */
  public static void registerWith(Registrar registrar) {
    final MethodChannel channel = new MethodChannel(registrar.messenger(), "user_agent");
    channel.setMethodCallHandler(new UserAgentPlugin(registrar.context()));
  }

  private final Context context;
  private Map<String, Object> constants;

  private UserAgentPlugin(Context context) {
